...
public class MsgDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements MsgDataReaderView
{
    ...
    public MsgDataReaderViewImpl(MsgTypeSupport ts)
    {
        typeSupport = ts;
