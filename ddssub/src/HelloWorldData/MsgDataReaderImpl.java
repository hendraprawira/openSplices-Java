...
public class MsgDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements MsgDataReader
{
    ...
    public MsgDataReaderImpl(MsgTypeSupport ts)
    {
        typeSupport = ts;
    ...
    */
    ...
    {
        return new MsgDataReaderViewImpl(typeSupport);
    }
}
